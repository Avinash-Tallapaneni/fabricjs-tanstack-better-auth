                ...
                <Button variant="outline" className="w-full" type="button">
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
                      ...
                      1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 
                      ...
                      2.22 0 1.606-.015 2.896-.015 3.286 
                ...
                >
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                    <path
                      ...
                      3.187-1.787 4.133-1.147 1.147-2.933 
                      2.4-6.053 2.4-4.827 0-8.6-3.893-8.6-8.72s3.773-8.72 
                      8.6-8.72c2.6 0 4.507 1.027 5.907 2.347l2.307-2.307C18.747 
                      1.44 16.133 0 12.48 0 5.867 0 .307 5.387.307 
                      12s5.56 12 12.173 12c3.573 0 6.267-1.173 
                      8.373-3.36 2.16-2.16 2.84-5.213 
